...
public class SpecialityModelTest {
    ...
    void testGetProfessionalsNames_populated() {
        ProfessionalModel professional1 = new ProfessionalModel(UUID.randomUUID(), "Dr. Smith", "123", null, null, null);
        ProfessionalModel professional2 = new ProfessionalModel(UUID.randomUUID(), "Dr. Jones",  "456", null, null, null);
    ...
    void testAddProfessional() {
        SpecialityModel speciality = new SpecialityModel(new SpecialityForm("Cardiologia",List.of(UUID.randomUUID())), new ArrayList<>());
        ProfessionalModel professional = new ProfessionalModel(UUID.randomUUID(), "Dr. Smith",  "123", null, null, null);
