...
class UnityControllerTest {
    ...
    public void testCreateUnity() {
        UnityInForm unityInForm = new UnityInForm("Unity", 10, new AddressFormDTO("street", 1, "neighborhood", "city", "state","123455-000"));
    ...
    public void testAlterUnity() {
        UUID id = UUID.randomUUID();
        UnityInForm unityInForm = new UnityInForm("Unity", 10, new AddressFormDTO("street", 1, "neighborhood", "city", "state","12344-000"));
        UnityDto unityDto = new UnityDto(new UnityModel());
