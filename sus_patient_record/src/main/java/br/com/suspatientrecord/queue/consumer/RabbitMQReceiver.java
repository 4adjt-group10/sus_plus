...
import br.com.suspatientrecord.queue.consumer.dto.Professional;
...
public class RabbitMQReceiver {
    ...
    @RabbitListener(queues = RabbitConfig.QUEUE_NAME_MANAGER_PATIENT_RECORD, ackMode = "MANUAL")
    public void receiveProfessionalMessage(Professional message,
        ...
        try {
            ...
            service.updateProfessional(message);
