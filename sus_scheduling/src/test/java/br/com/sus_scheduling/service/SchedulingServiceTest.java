...
//
//    @Test
//    void postValidateManager_shouldApproveAndSaveScheduling() {
//        MessageBodyByManager message = new MessageBodyByManager(appointment,professionalId,true,schedulingId);
//        when(schedulingRepository.findById(schedulingId)).thenReturn(Optional.of(scheduling));
//
...
//
//    @Test
//    void postValidateManager_shouldCancelAndSendEmailWhenNotValidated() {
//        MessageBodyByManager message = new MessageBodyByManager(appointment,professionalId,false,schedulingId);
//        when(schedulingRepository.findById(schedulingId)).thenReturn(Optional.of(scheduling));
//
//        schedulingService.postValidateManager(message);
//
...
//
//    @Test
//    void update_shouldUpdateSchedulingAndSendMessage() {
//        LocalDateTime newAppointment = LocalDateTime.now().plusDays(2);
//        SchedulingUpdateDTO updateDTO = new SchedulingUpdateDTO(professionalId, Optional.ofNullable(appointment),SCHEDULED);
//        when(schedulingRepository.findById(schedulingId)).thenReturn(Optional.of(scheduling));
//
//        SchedulingDTO result = schedulingService.update(schedulingId, updateDTO);
//
//        assertNotNull(result);
//        verify(messageProducer, times(1)).sendToUnity(any(MessageBodyForUnity.class));
//        verify(schedulingRepository, times(1)).save(scheduling);
